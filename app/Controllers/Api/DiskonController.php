...
class DiskonController extends ResourceController
{
    ...
    public function index()
    {
        ...
        $discounts = $this->model->orderBy('tanggal', 'ASC')->paginate($perPage, 'default', $page);
    ...
    public function create()
    {
        ...
        $cek = $this->model->where('tanggal', $data['tanggal'] ?? null)->first();
        if ($cek) {
    ...
    public function update($id = null)
    {
        ...
        // tanggal tidak boleh diubah lewat webservice, hanya nominal
        unset($data['tanggal']);
