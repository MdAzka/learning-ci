...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link
        href="<?= base_url() ?>NiceAdmin/assets/vendor/bootstrap/css/bootstrap.min.css"
        rel="stylesheet" />
    <link
        href="<?= base_url() ?>NiceAdmin/assets/vendor/bootstrap-icons/bootstrap-icons.css"
        rel="stylesheet" />
    ...
    <link
        href="<?= base_url() ?>NiceAdmin/<?= base_url() ?>NiceAdmin/<?= base_url() ?>NiceAdmin/assets"
        rel="stylesheet" />
